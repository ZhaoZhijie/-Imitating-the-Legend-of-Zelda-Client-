...
#define _ROOM_DATA 4//大厅房间数据
#define _ENTER_HALL 5//进入大厅场景请求大厅数据
#define _CREATE_ROOM 6//新建房间
#define _CREATE_RESULT 7//房间创建结果
#define _ENTER_ROOM 8//进入房间申请
#define _PLAYER_DATA 9//玩家数据
#define  _EROOM_RESULT 10//房间人已满
#define  _OWNER_DATA 11//当前玩家数据
#define _CUR_ROOM 12//当前房间数据
#define _PRE_CLICK 13//玩家点击准备按钮
#define _PRE_CLICK_RESULT 14//玩家准备点击处理结果
#define _I_QUIT 15//告知服务器退出房间
#define _H_QUIT 16//告知玩家房间另一个玩家退出
#define  _ROOM_DEL 17//房间删除
#define  _PLAYER_INPUT 18//玩家输入
#define  _PLAYER_OUTPUT 19//玩家输出
#define  _CLICK_START 20 //点击开始
#define  _ENTER_GAME 21//告知玩家可以进入游戏场景
#define  _GAME_WAIT 22//告知服务器已进入游戏场景等待其他玩家中
#define  _GAME_START 23//告知玩家所有玩家都已就绪可以开始接受画面和传递控制信息
